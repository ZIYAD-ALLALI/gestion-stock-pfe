<template>
  <v-card class="elevation-0">
    ...
    >
      <template v-slot:top>
        <v-toolbar flat>
          <v-toolbar-title>Nos Fournisseurs</v-toolbar-title>
          ...
          <v-text-field
            ...
            hide-details
          ></v-text-field>
          <v-snackbar v-model="responseSuccess" dense timeout="1000" color="success" text>
      ...
      <template v-slot:no-data>
        <v-btn color="primary" @click="retrieveFournisseurs">
          Reset
        </v-btn>
      </template>
    </v-data-table>
...
export default {
  ...
  methods: {
    ...
    deleteItemConfirm() {
      FournisseurDataService.delete(this.Fournisseurs[this.editedIndex].id);
      this.closeDelete();
      this.retrieveFournisseurs();
    },
    ...
    save() {
      if (this.valid == true) {
        if (this.editedIndex > -1) {
          FournisseurDataService.update(
            this.Fournisseurs[this.editedIndex].id,
            this.editedItem
          );
        } else {
          FournisseurDataService.create(this.editedItem);
